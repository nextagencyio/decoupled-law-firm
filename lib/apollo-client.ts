...
export function getServerApolloClient(requestHeaders: Headers): ApolloClient<any> {
  ...
  return new ApolloClient({
    ...
    cache: new InMemoryCache({
      possibleTypes: {
        TermInterface: ['TermPracticeArea', 'TermAttorneyRole', 'TermNewsCategory', 'TermCategory'],
        NodeInterface: ['NodePracticeArea', 'NodeAttorney', 'NodeCaseStudy', 'NodeNews', 'NodePage', 'NodeHomepage'],
      },
    }),
    defaultOptions: {
      watchQuery: {
